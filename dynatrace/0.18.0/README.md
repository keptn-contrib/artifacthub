...
![](https://raw.githubusercontent.com/keptn-contrib/dynatrace-service/release-0.18.0/documentation/images/dynatraceserviceoverview.png)
...
![](https://raw.githubusercontent.com/keptn-contrib/dynatrace-service/release-0.18.0/documentation/images/defaultdynatracetags.png)
...
If you are planning to upgrade to *dynatrace-service* version `0.18.0` from a previous version, then please make sure to read and follow [these instructions on patching your secrets](https://raw.githubusercontent.com/keptn-contrib/dynatrace-service/release-0.18.0/documentation/patching-dynatrace-secrets.md) before doing the upgrade.


## Overview
- [Installation](https://raw.githubusercontent.com/keptn-contrib/dynatrace-service/release-0.18.0/documentation/installation.md)
- [Configuration](https://raw.githubusercontent.com/keptn-contrib/dynatrace-service/release-0.18.0/documentation/configuration.md)
- [SLI and SLO configuration](https://raw.githubusercontent.com/keptn-contrib/dynatrace-service/release-0.18.0/documentation/sli-configuration.md)
- [Development](https://raw.githubusercontent.com/keptn-contrib/dynatrace-service/release-0.18.0/documentation/development.md)
