...
the [`https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/deploy/service.yaml`](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/deploy/service.yaml) file:
...
* Deploy the service
  ...
  in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/skaffold.yaml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/skaffold.yaml))

### Testing Cloud Events

We have dummy cloud-events in the form of [RFC 2616](https://ietf.org/rfc/rfc2616.txt) requests in
the [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/test-events/](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/test-events/) directory. These can be easily executed using third party plugins such as
...
You can find the details in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/.github/workflows/reviewdog.yml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/.github/workflows/reviewdog.yml).

### GitHub Actions: Unit Tests

This repo has automated unit tests for pull requests.

You can find the details in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/.github/workflows/tests.yml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/.github/workflows/tests.yml).

### GH Actions/Workflow: Build Docker Images

This repo uses GH Actions and Workflows to test the code and automatically build docker images.

Docker Images are automatically pushed based on the configuration done in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/.ci_env](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/.ci_env) and the
...
* write release notes in the [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/releasenotes/](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/releasenotes/) folder,
...
Please find more information in the [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/LICENSE](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0.1.0/LICENSE) file.
