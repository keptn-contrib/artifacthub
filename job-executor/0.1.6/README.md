...
- [Documentation](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#documentation)
    - [Why?](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#why)
    - [How?](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#how)
        - [Specifying the working directory](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#specifying-the-working-directory)
        - [Event Matching](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#event-matching)
        - [Kubernetes Job](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#kubernetes-job)
        - [Kubernetes Job Environment Variables](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#kubernetes-job-environment-variables)
            - [From Events](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#from-events)
            - [From Kubernetes Secrets](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#from-kubernetes-secrets)
            - [From String Literal](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#from-string-literal)
        - [File Handling](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#file-handling)
        - [Silent mode](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#silent-mode)
        - [Resource quotas](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#resource-quotas)
        - [Poll duration](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#poll-duration)
        - [Job namespace](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#job-namespace)
        - [Job image pull policy](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#job-image-pull-policy)
        - [Send start/finished event if the job config.yaml can't be found](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#send-startfinished-event-if-the-job-configyaml-cant-be-found)
        - [Additional Event Data](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#additional-event-data)
        - [Remote Control Plane](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#remote-control-plane)
        - [Job clean-up](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#job-clean-up)
    - [How to validate a job configuration](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#how-to-validate-a-job-configuration)
    - [Endless Possibilities](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#endless-possibilities)
...
The kubernetes secret is always looked up in the [namespace](https://github.com/keptn-contrib/job-executor-service/blob/main/README.md#job-namespace) the respective task runs in.
...
can be set in [`https://raw.githubusercontent.com/keptn-contrib/job-executor-service/main/deploy/service.yaml`](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/main/deploy/service.yaml):
...
or for helm in [`https://raw.githubusercontent.com/keptn-contrib/job-executor-service/main/helm/templates/configmap.yaml`](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/main/helm/templates/configmap.yaml):
