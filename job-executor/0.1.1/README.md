...
the [`https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/deploy/service.yaml`](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/deploy/service.yaml) file:
...
* Deploy the service
  ...
  in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/skaffold.yaml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/skaffold.yaml))

### Testing Cloud Events

We have dummy cloud-events in the form of [RFC 2616](https://ietf.org/rfc/rfc2616.txt) requests in
the [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/test-events/](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/test-events/) directory. These can be easily executed using third party plugins such as
...
You can find the details in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/.github/workflows/reviewdog.yml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/.github/workflows/reviewdog.yml).

### GitHub Actions: Unit Tests

This repo has automated unit tests for pull requests.

You can find the details in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/.github/workflows/tests.yml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/.github/workflows/tests.yml).

### GH Actions/Workflow: Build Docker Images

This repo uses GH Actions and Workflows to test the code and automatically build docker images.

Docker Images are automatically pushed based on the configuration done in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/.ci_env](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/.ci_env) and the
...
* write release notes in the [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/releasenotes/](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/releasenotes/) folder,
* update the compatibility matrix,
* check the output of GH Actions builds for the release branch,
* verify that your image was built and pushed to DockerHub with the right tags,
* update the image tags for `job-executor-service` and `job-executor-service-initcontainer` in [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/deploy/service.yaml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/deploy/service.yaml), [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/helm/Chart.yaml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/helm/Chart.yaml), [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/helm/values.yaml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/helm/values.yaml) and [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/helm/templates/configmap.yaml](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/helm/templates/configmap.yaml)
...
Please find more information in the [https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/LICENSE](https://raw.githubusercontent.com/keptn-contrib/job-executor-service/release-0-1-1/LICENSE) file.
