...
This service reacts on the following Keptn CloudEvents (see [https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/deploy/service.yaml](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/deploy/service.yaml)):
...
Ensure that the correct `ChaosEngine` spec is provided in the [experiment manifest](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/test-data/litmus/experiment.yaml) along with the 
corresponding `ChaosExperiment` CR & RBAC manifests. 

- This repo uses the sample [*helloservice*](https://github.com/keptn-sandbox/litmus-service/tree/master/test-data/helloservice) app as the Application-Under-Test (AUT)   to illustrate the impact of chaos. Hence, the [experiment](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/test-data/litmus/experiment.yaml) is populated with the respective attributes for app filtering purposes. Ensure you have the right data placed in the `spec.appinfo` when adopting this for your environments.

## Installation -  Deploy in your Kubernetes cluster

To deploy the current version of the *litmus-service* in your Keptn Kubernetes cluster, clone the repo and apply the [`https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/deploy/service.yaml`](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/deploy/service.yaml) file:
...
To delete the litmus-service, delete using the [`https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/deploy/service.yaml`](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/deploy/service.yaml) file:
...
You can find the details in [https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/.github/workflows/reviewdog.yml](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/.github/workflows/reviewdog.yml).

### GitHub Actions: Unit Tests

This repo has automated unit tests for pull requests. 

You can find the details in [https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/.github/workflows/CI.yml](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/.github/workflows/CI.yml).
...
Furthermore, the variable `IMAGE` needs to be configured properly in [https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/.ci_env](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/.ci_env)
...
* write release notes in the [https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/releasenotes/](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/releasenotes/) folder,
...
Please find more information in the [https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/LICENSE](https://raw.githubusercontent.com/keptn-sandbox/litmus-service/master/LICENSE) file.
