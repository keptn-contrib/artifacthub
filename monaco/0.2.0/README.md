...
To deploy the current version of the *monaco-service* in your Keptn Kubernetes cluster, apply the [`https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/deploy/service.yaml`](https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/deploy/service.yaml) file:
...
For an example, please check [tagging.json](https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/monaco/projects/monaco/auto-tag/tagging.json/)
...
If you don't care about the details, your first entrypoint is [https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/eventhandlers.go](https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/eventhandlers.go). Within this file 
 you can add implementation for pre-defined Keptn Cloud events.
 
To better understand Keptn CloudEvents, please look at the [Keptn Spec](https://github.com/keptn/spec).
 
If you want to get more insights, please look into [https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/main.go](https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/main.go), [https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/deploy/service.yaml](https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/deploy/service.yaml),
...
* Deploy the service using [Skaffold](https://skaffold.dev/): `skaffold run --default-repo=your-docker-registry --tail` (Note: Replace `your-docker-registry` with your DockerHub username; also make sure to adapt the image name in [https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/skaffold.yaml](https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/skaffold.yaml))


### Testing Cloud Events

We have dummy cloud-events in the form of [RFC 2616](https://ietf.org/rfc/rfc2616.txt) requests in the [https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/test-events/](https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/test-events/) directory. These can be easily executed using third party plugins such as the [Huachao Mao REST Client in VS Code](https://marketplace.visualstudio.com/items?itemName=humao.rest-client).


## License

Please find more information in the [https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/LICENSE](https://raw.githubusercontent.com/keptn-sandbox/monaco-service/release-0.2.0/LICENSE) file.
